...
Future<void> regenerate() async {
  ...
  await dir.create();
  print('-Regenerating');
  await createLevel(3, 1);
  await createLevel(3, 1);
  await createLevel(4, 1);
  await createLevel(4, 1);
  await createLevel(5, 1);
  await createLevel(5, 1);
  await createLevel(6, 2);
  await createLevel(6, 2);
  await createLevel(7, 2);
  await createLevel(7, 2);
  await createLevel(8, 2);
  await createLevel(8, 2);
  await createLevel(9, 2);
  await createLevel(9, 2);
  await createLevel(10, 2);
  await createLevel(10, 2);
